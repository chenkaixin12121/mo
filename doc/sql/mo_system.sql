/*
 ...
 Source Schema         : mo_system

 Target Server Type    : MySQL
 Target Server Version : 80027
 File Encoding         : 65001

 Date: 23/11/2023 18:18:45
*/
USE mo_system;
...
INSERT INTO `sys_dict_item` VALUES (8, 'micro_service', '系统服务', 'mo-system', 1, 2, 0, NULL, 0, '2023-11-15 14:22:47', '2023-11-15 14:22:47');
...
CREATE TABLE `sys_menu`  (
  ...
  `update_time` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1727606519207305218 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单管理' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'root', '超级管理员', 0, '$2a$10$BEMKNROPITz2Jm2a4myL4uAA776wilSPiKAb8dBIP/lLcglukQeW2', 1, 'https://file.ckx.ink/upload/2020/04/android-chrome-512x512.png', '18348388576', 'chenkaixin12121@163.com', 1, 0, '2023-11-15 01:31:29', '2023-11-15 01:31:29');
INSERT INTO `sys_user` VALUES (2, 'admin', '系统管理员', 1, '$2a$10$BEMKNROPITz2Jm2a4myL4uAA776wilSPiKAb8dBIP/lLcglukQeW2', 2, 'https://file.ckx.ink/upload/2020/04/android-chrome-512x512.png', '18348388576', '', 1, 0, '2023-11-15 01:31:29', '2023-11-15 01:31:29');
INSERT INTO `sys_user` VALUES (3, 'test', '测试小用户', 2, '$2a$10$.V285U.inSazxaWuTBhERetyCzGWUSWG8tHPEImDm02W8a5hWD6ua', 3, 'https://file.ckx.ink/upload/2020/04/android-chrome-512x512.png', '18348388576', 'chenkaixin12121@163.com', 1, 0, '2023-11-15 01:31:29', '2023-11-15 01:31:29');
